...
public class memberPanel extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == paymentButton) {
            ...
            ImageIcon iconOfYesNo = new ImageIcon("IMG/paid.jpg");
            ...
            if (choice == JOptionPane.YES_OPTION) {
                ...
                ImageIcon icon = new ImageIcon("IMG/onlinepayment.jpg");
                ...
                if (method == 0) {
                    ...
                    ImageIcon iconOfCard = new ImageIcon("IMG/card.jpg");
                    ...
                    ImageIcon iconOfMobileBanking = new ImageIcon("IMG/mobilebanking.jpg");
                    ...
                    if (methodOfMobileBanking.equals("BKash")) {
                        ...
                        ImageIcon iconOfCard = new ImageIcon("IMG/rocket.jpg");
                        String MobileNumber = (String) JOptionPane.showInputDialog(null, "Enter your mobile number",
                                "Mobile number", JOptionPane.QUESTION_MESSAGE, iconOfCard, null, "xxx-xxxxxxxx");
                        ...
                        ImageIcon iconOfCard = new ImageIcon("IMG/nagad.jpg");
                        String MobileNumber = (String) JOptionPane.showInputDialog(null, "Enter your mobile number",
